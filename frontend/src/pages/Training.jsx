...
export default function Training() {
  ...
  useEffect(() => {
    const fetchEventos = async () => {
      try {
        console.log("🔍 Buscando eventos em:", `${API_URL}/api/eventos`);
  ...
  const enviarInscricao = async (e) => {
    ...
    try {
      const response = await fetch(`${API_URL}/api/inscricoes-eventos`, {
        ...
        body: JSON.stringify({ ...inscricaoForm, eventId: inscricaoModal.id })
      });
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <section className="relative py-16 md:py-24 bg-zinc-900 border-b border-zinc-800 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <h1 className="font-display text-4xl md:text-7xl mb-6 text-white">ENTRENAMIENTOS</h1>
      ...
      <section className="py-12 md:py-16 bg-zinc-950">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 p-6 md:p-8 hover:border-red-600/50 transition-colors group">
              <p className="text-zinc-600 text-xs uppercase tracking-widest mb-4">Ubicación</p>
              <h3 className="font-display text-xl md:text-3xl text-white mb-2 group-hover:text-red-500 transition-colors">PABELLÓN MALVARROSA</h3>
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6 md:p-8 hover:border-red-600/50 transition-colors group">
              ...
              <h3 className="font-display text-2xl md:text-3xl text-white mb-2 group-hover:text-red-500 transition-colors">17:00 - 19:30</h3>
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6 md:p-8 hover:border-red-600/50 transition-colors group">
              ...
              <h3 className="font-display text-2xl md:text-3xl text-white mb-2 group-hover:text-red-500 transition-colors">10:00 - 11:30</h3>
      ...
      <section className="py-12 md:py-16 bg-zinc-900 border-y border-zinc-800">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10 md:mb-12">
            ...
            <h2 className="font-display text-3xl md:text-5xl text-white mb-4">PRÓXIMOS EVENTOS</h2>
          ...
          {loadingEventos ? (
            ...
            <div className="grid grid-cols-1 gap-6">
              {eventos.map((evento) => (
                <div key={evento.id} className="bg-zinc-950 border border-zinc-800 p-6 rounded-sm hover:border-red-600/50 transition-all duration-300 group">
                  <div className="flex flex-col gap-4">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                      <div className="flex-shrink-0 flex items-center justify-center bg-zinc-900 border border-zinc-800 rounded-sm p-4 min-w-[120px]">
                        <div className="text-center">
                          <span className="font-display text-3xl text-red-500 leading-none block">{evento.date}</span>
                          <span className="text-zinc-400 text-xs uppercase tracking-widest block mt-1">{evento.month}</span>
                          <span className="text-zinc-500 text-[10px] uppercase block mt-0.5">{evento.day}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex-grow">
                        ...
                        <h3 className="font-display text-xl md:text-2xl text-white mb-2 group-hover:text-red-500 transition-colors">{evento.name}</h3>
      ...
      <section className="py-12 md:py-16 bg-zinc-950">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10 md:mb-12">
            ...
            <h2 className="font-display text-3xl md:text-5xl text-white mb-4">NUESTRA UBICACIÓN</h2>
            <div className="w-24 h-1 bg-red-600 mx-auto"></div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-red-600 relative overflow-hidden">
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-display text-3xl md:text-6xl mb-6 text-white">¿LISTO PARA ENTRENAR?</h2>
          <p className="text-lg md:text-xl mb-8 md:mb-10 text-red-100 font-light">Únete a la manada y descubre el rugby en silla de ruedas.</p>
