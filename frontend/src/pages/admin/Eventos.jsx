                ...
                (ev) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-5">
                      ...
                      <span
                        className={`inline-flex mt-3 items-center px-2.5 py-1 rounded-sm text-[9px] font-bold uppercase tracking-wider border ${getTypeStyle(ev.type)}`}
                      >
                        {ev.type}
                      </span>
                      ...
                      <div className="flex items-center justify-end gap-1">
                        ...
                        {ev.status !==
                          ...
                          <button
                            ...
                            className="p-2.5 text-green-500 hover:text-green-400 hover:bg-green-500/10 rounded-sm transition-colors"
                          ...
                          <button
                            ...
                            className="p-2.5 text-yellow-500 hover:text-yellow-400 hover:bg-yellow-500/10 rounded-sm transition-colors"
                        ...
                        {ev.status ===
                          ...
                          >
                            <Icon
                              path="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14M14 8h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2H6z"
                            />
                          </button>
                        )}
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 text-xs mt-1">
                    {galeriaEvento.fotos?.length ||
                      0}{' '}
                    imagen(es)
                  </p>
                </div>

                <label className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-red-600 hover:bg-red-500 text-white text-xs font-bold uppercase tracking-widest cursor-pointer transition-colors rounded-sm">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-sm max-w-md w-full p-7 shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 bg-zinc-800 border border-zinc-700 text-zinc-300 font-bold uppercase text-xs tracking-widest hover:bg-zinc-700 transition-colors rounded-sm"
              >
                Cancelar
              </button>
              ...
              <button
                ...
                className="flex-1 py-3 bg-green-600 text-white font-bold uppercase text-xs tracking-widest hover:bg-green-500 transition-colors rounded-sm"
              >
                Finalizar
              </button>
          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 bg-zinc-800 text-zinc-300 font-bold uppercase text-xs tracking-widest rounded-sm hover:bg-zinc-700 transition-colors"
              >
                Cancelar
              </button>
              ...
              <button
                ...
                className="flex-1 py-3 bg-red-600 text-white font-bold uppercase text-xs tracking-widest rounded-sm hover:bg-red-500 transition-colors"
              >
                Sí, Eliminar
              </button>
