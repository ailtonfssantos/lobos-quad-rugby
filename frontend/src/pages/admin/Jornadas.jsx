      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div>
          ...
          <p className="text-zinc-500 text-sm">
            Administre jornadas, partidos, equipos, logos, horarios y retransmisiones.
          </p>
        ...
        >
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-6 leading-relaxed">
              ¿Está seguro de que desea eliminar esta jornada? También se eliminarán todos los partidos asociados.
            </p>
