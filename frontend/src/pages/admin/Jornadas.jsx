...
export default function Jornadas() {
  ...
  const openModal = (jornada = null) => {
    if (jornada) {
      ...
      const partidosRellenos = Array.isArray(
        jornada.partidos
      )
        ? [...jornada.partidos]
        : [];
      ...
      while (
        partidosRellenos.length < 3
      ) {
        partidosRellenos.push({
          ...initialPartido
        });
      }
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <p className="text-zinc-500 text-sm">
            Administre las jornadas, temporadas,
            banners, horarios y enlaces de transmisión.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <p className="
              ...
              mb-6
            ">
              ¿Está seguro? Se eliminarán
              también todos los partidos de
              esta jornada.
            </p>
