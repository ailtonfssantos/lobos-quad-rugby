    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {/* Overlays */}
          <div className="absolute inset-0 bg-gradient-to-br from-red-950/50 via-black/90 to-black/95" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-zinc-400 leading-relaxed max-w-xl">
                Entrena con nosotros, descubre el rugby en silla de ruedas 
                y forma parte de un equipo que compite, crece y abre camino.
              </p>
            </div>
