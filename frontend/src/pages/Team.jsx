...
/**
 * Determina se o membro pertence à estrutura de staff/direção.
 *
 * Mantemos compatibilidade com os valores atuais do backend.
 */
const getRolePriority = (role) => {
  ...
  if (r.includes('CAPITAN')) return 4;
...
/**
 * Retorna a categoria visual do membro.
 *
 * Não depende exclusivamente de "role", mas também aceita
 * position/posición caso esses campos existam futuramente.
 */
...
/**
 * Retorna a cor do indicador de role.
 */
 ...
 *
 * Mantido apenas como fallback caso você queira randomização.
 * Nesta versão usamos uma ordem estável para UX profissional.
 */
...
/**
 * Ordenação estável dos jogadores.
 *
 * Primeiro tenta usar "order/orden" caso exista no backend.
 * Depois usa nome.
 */
...
export default function Team() {
  ...
  const fetchPlayers = useCallback(async (signal) => {
    ...
    try {
      ...
      /* ================================================
         ...
         Si en el futuro el backend tiene:
         order / orden
      ...
      /*
       * AbortError acontece quando o componente é desmontado
       * ou quando a requisição é cancelada.
       */
  ...
  const handleImageError = (event) => {
    ...
    /*
     * Evita loop infinito caso até o fallback falhe.
     */
          ...
          {!loading && !error && (
            <div className="mt-14 pt-8 border-t border-zinc-800 grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <p className="mt-2 text-[10px] text-zinc-500 uppercase tracking-[0.2em]">
                  Miembros
                </p>
              </div>
        ...
        <section className="py-32 bg-zinc-950">
          <div className="max-w-xl mx-auto px-4 text-center">
            ...
            <p className="text-white font-display text-2xl mb-3">
              No hemos podido cargar la manada
            </p>
