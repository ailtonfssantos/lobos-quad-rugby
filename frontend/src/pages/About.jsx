          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-10 flex items-center gap-4 text-sm uppercase tracking-wider text-white">
                ...
                <span className="text-red-500 italic text-3xl font-black leading-none">
                  “
                </span>
            ...
            <article className="bg-[#080808] p-8 lg:p-10 group hover:bg-[#0d0d0d] transition-colors duration-300">
              ...
              <div className="mt-16">
                ...
                <p className="mt-5 text-gray-500 leading-relaxed">
                  ...
                  romper barreras y acercar el rugby en silla de ruedas
              ...
              <div className="relative border-l border-white/10">
                ...
                <div className="relative pl-8 pb-16">
                  ...
                  <p className="mt-4 text-gray-500 leading-relaxed max-w-2xl">
                    El rugby en silla de ruedas nació en Canadá a finales
                    de los años 70. Es un deporte de contacto e intensidad
                    diseñado para personas con diferentes tipos de
                    discapacidad que afectan a las extremidades.
                  </p>

                  <p className="mt-4 text-gray-500 leading-relaxed max-w-2xl">
                    Su carácter adaptado y su exigencia física lo convierten
                    en una disciplina única dentro del deporte adaptado.
                  </p>
                ...
                <div className="relative pl-8 pb-16">
                  ...
                  <p className="mt-4 text-gray-500 leading-relaxed max-w-2xl">
                    ...
                    comienzan a dar forma al proyecto. Los primeros pasos
                    estuvieron marcados por la dificultad de acceder a
                    material deportivo específico.
                  </p>

                  <p className="mt-4 text-gray-500 leading-relaxed max-w-2xl">
                    Las sillas deportivas específicas suponían una inversión
                    cercana a los 5.000 euros, por lo que los primeros
                    entrenamientos se realizaron con sillas deportivas
                    multidisciplinares.
                  </p>
                ...
                <div className="relative pl-8">
                  ...
                  <p className="mt-4 text-gray-500 leading-relaxed max-w-2xl">
                    Desde entonces, el club ha continuado desarrollando
                    su proyecto deportivo y dos de nuestros jugadores han
                    sido convocados por la Selección Española.
                  </p>
