          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="mt-10 flex items-center gap-4 text-sm uppercase tracking-wider text-white">
                <span className="text-red-500 italic text-3xl font-black leading-none">"</span>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12">
            <div>
              ...
              <h2 className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-black uppercase">Lobos en números</h2>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border border-white/10">
            <div className="p-7 lg:p-10 border-r border-b lg:border-b-0 border-white/10">
              <span className="text-5xl lg:text-6xl font-black text-white">2017</span>
            ...
            <div className="p-7 lg:p-10 lg:border-r border-b lg:border-b-0 border-white/10">
              <span className="text-5xl lg:text-6xl font-black text-white">2019</span>
            ...
            <div className="p-7 lg:p-10 border-r border-white/10">
              <span className="text-5xl lg:text-6xl font-black text-red-600">2</span>
              <p className="mt-3 text-xs uppercase tracking-[0.2em] text-gray-500">Jugadores con España</p>
            </div>
            <div className="p-7 lg:p-10">
              <span className="text-4xl lg:text-5xl font-black text-white">VALENCIA</span>
      ...
      <section className="py-24 lg:py-32 bg-[#080808] border-y border-white/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="mt-4 text-4xl sm:text-5xl font-black uppercase">Tres pilares</h2>
            <p className="mt-5 text-gray-500 text-lg leading-relaxed">Áreas que definen la actividad de Lobos dentro y fuera de la pista.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-px bg-white/10">
            <article className="bg-[#080808] p-8 lg:p-10 group hover:bg-[#0d0d0d] transition-colors duration-300">
              ...
              <div className="mt-16">
                <h3 className="text-2xl font-black uppercase">Deporte de competición</h3>
                <p className="mt-5 text-gray-500 leading-relaxed">Primer equipo de la Comunidad Valenciana en la Liga Nacional desde 2019, participando en torneos de élite y formando jugadores de alto rendimiento.</p>
                <Link to="/competiciones" className="inline-flex items-center gap-2 mt-7 text-xs uppercase tracking-widest text-white hover:text-red-500 transition-colors">
            ...
            <article className="bg-[#080808] p-8 lg:p-10 group hover:bg-[#0d0d0d] transition-colors duration-300">
              ...
              <div className="mt-16">
                <h3 className="text-2xl font-black uppercase">Canal de sensibilización</h3>
                <p className="mt-5 text-gray-500 leading-relaxed">Utilizamos el deporte para visibilizar la discapacidad, romper barreras y acercar el rugby en silla de ruedas a todas las personas mediante exhibiciones y charlas.</p>
              </div>
            </article>
            ...
            <article className="bg-[#080808] p-8 lg:p-10 group hover:bg-[#0d0d0d] transition-colors duration-300">
              ...
              <div className="mt-16">
                <h3 className="text-2xl font-black uppercase">Ocio y salud</h3>
                <p className="mt-5 text-gray-500 leading-relaxed">Promoción de actividades físico-deportivas no competitivas para personas con discapacidad que desean mantener y mejorar su calidad de vida y autonomía.</p>
                <Link to="/unete" className="inline-flex items-center gap-2 mt-7 text-xs uppercase tracking-widest text-white hover:text-red-500 transition-colors">
                  Únete a los Lobos <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </article>
          </div>
            ...
            <div className="lg:col-span-8">
              <div className="relative border-l border-white/10">
                <div className="relative pl-8 pb-16">
                  ...
                  <span className="text-sm font-mono text-gray-500">ORIGEN</span>
                  <h3 className="mt-3 text-2xl font-black uppercase">Rugby en silla de ruedas</h3>
                  <p className="mt-4 text-gray-500 leading-relaxed max-w-2xl">
                    Nació en Canadá a finales de los años 70. Es un deporte de contacto e intensidad diseñado para personas con discapacidad que afecta a las extremidades (tetraplejia, distrofias, amputaciones), ofreciendo una oportunidad única de deporte de alta exigencia.
                  </p>
                </div>

                <div className="relative pl-8 pb-16">
                  <span className="absolute -left-[5px] top-1 w-2 h-2 bg-red-600 rounded-full" />
                  <span className="text-sm font-mono text-red-500">2017</span>
                  <h3 className="mt-3 text-2xl font-black uppercase">El comienzo</h3>
                  <p className="mt-4 text-gray-500 leading-relaxed max-w-2xl">
                    Carlos Sanchis y un grupo de potenciales jugadores comienzan a dar forma al proyecto en Valencia. Los primeros pasos estuvieron marcados por la dificultad de acceder a material específico, ya que las sillas deportivas suponían una inversión cercana a los 5.000 euros, por lo que se entrenó con sillas multidisciplinares.
                  </p>
                </div>

                <div className="relative pl-8">
                  <span className="absolute -left-[5px] top-1 w-2 h-2 bg-red-600 rounded-full" />
                  <span className="text-sm font-mono text-red-500">2019</span>
                  <h3 className="mt-3 text-2xl font-black uppercase">Llegamos a la Liga Nacional</h3>
                  <p className="mt-4 text-gray-500 leading-relaxed max-w-2xl">
                    Lobos se convierte en el primer equipo de la Comunidad Valenciana en competir en la Liga Nacional. Desde entonces, el club ha seguido creciendo y dos de nuestros jugadores han sido convocados por la Selección Española.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="mt-8 text-lg lg:text-xl text-black/80 max-w-2xl leading-relaxed">
                Dos jugadores de Lobos han sido convocados con la Selección Española. Un reconocimiento al trabajo, compromiso y nivel deportivo alcanzado por nuestros atletas.
              </p>
            </div>
            <div className="lg:col-span-4 lg:text-right">
              <div className="inline-block">
                <span className="block text-[7rem] lg:text-[9rem] leading-none font-black text-black">02</span>
                <span className="block mt-2 text-sm uppercase tracking-[0.25em] font-bold text-black/70">Convocados con España</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-12">
            <div>
              ...
              <h2 className="mt-4 text-4xl sm:text-5xl font-black uppercase">Vive la experiencia</h2>
            </div>
            <p className="text-gray-500 max-w-md leading-relaxed">
              El rugby en silla de ruedas se entiende mejor cuando se vive. Descubre nuestra realidad dentro y fuera de la pista.
            </p>
          </div>
            ...
            <div className="lg:col-span-8">
              <div className="divide-y divide-white/10 border-y border-white/10">
                {['Inclusión y accesibilidad', 'Esfuerzo y superación', 'Trabajo en equipo', 'Respeto y fair play', 'Pasión por el deporte'].map((valor, index) => (
                  <div key={index} className="py-7 flex items-center gap-5">
                    <CheckIcon className="text-red-600 shrink-0" />
                    <span className="text-xl lg:text-2xl font-bold uppercase">{valor}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="max-w-4xl">
            ...
            <p className="mt-8 text-lg lg:text-xl text-black/75 max-w-2xl leading-relaxed">
              Ya sea dentro de la pista, apoyando al equipo o colaborando con el proyecto, hay muchas formas de formar parte de la manada.
            </p>
            <div className="mt-10 flex flex-wrap gap-4">
              <Link to="/unete" className="group inline-flex items-center gap-3 bg-black text-white px-7 py-4 text-sm font-bold uppercase tracking-wide hover:bg-white hover:text-black transition-all duration-300">
                Quiero unirme <ArrowUpRight className="transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1" />
              </Link>
              <Link to="/equipo" className="inline-flex items-center gap-3 border border-black/30 text-black px-7 py-4 text-sm font-bold uppercase tracking-wide hover:bg-black hover:text-white transition-all duration-300">
                Conocer al equipo <ArrowRight />
              </Link>
            </div>
          </div>
        </div>
