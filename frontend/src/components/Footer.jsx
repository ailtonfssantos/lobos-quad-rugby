      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-10">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="mt-7 max-w-lg text-sm leading-7 text-zinc-500">
                Club deportivo de rugby en silla de ruedas nacido en Valencia para competir, crecer y abrir camino.
              </p>

              {/* Social (Tamanhos ajustados e classes corrigidas) */}
              <div className="mt-8 flex items-center gap-3">
                <a
                  ...
                  className="group flex h-9 w-9 items-center justify-center border border-white/10 text-zinc-500 transition-all duration-300 hover:border-red-600 hover:bg-red-600 hover:text-white"
                >
            ...
            <div className="lg:col-span-4">
              ...
              <div className="space-y-7">
                <div>
                  ...
                  <p className="mt-2 text-sm text-zinc-300">Pabellón Playa Malvarrosa</p>
                  <p className="mt-1 text-xs text-zinc-600">Valencia, España</p>
                </div>
                <div>
                  <div className="text-[8px] font-bold uppercase tracking-[0.25em] text-zinc-700">
                    Horario
                  ...
                  <div className="mt-2 space-y-1">
                    <p className="text-sm text-zinc-300">
                      Lunes y miércoles<span className="text-zinc-600"> · </span>17:00 — 19:30
                    </p>
                    <p className="text-sm text-zinc-300">
                      Viernes<span className="text-zinc-600"> · </span>10:00 — 11:30
                    </p>
                  </div>
                </div>
                <div>
                  ...
                  <a href="mailto:lobosqr@gmail.com" className="mt-2 inline-block text-sm text-zinc-300 transition-colors hover:text-red-500">
                    lobosqr@gmail.com
                  </a>
                </div>
              </div>
        ...
        <div className="py-7">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <nav aria-label="Información legal" className="flex flex-wrap gap-x-6 gap-y-3">
              {legalLinks.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
